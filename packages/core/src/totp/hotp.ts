 ...
 */
export async function generateHotp(secret: Buffer, counter: number, params: HotpParams): Promise<string> {
  ...
  const digest = await hmac(ALGORITHM_MAP[params.algorithm], secret, counterBytes);
